        ...
        <section class="content">
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title">编辑售票点</h3>
                    <div class="box-tools">
                        <a href="/base/office/${office.id}/detail" class="btn btn-success btn-sm">返回</a>
                    </div>
                </div>
                <div class="box-body">
                    <form method="post" id="saveForm">

                        <input type="hidden" name="legalPersonCardUp" value="${office.legalPersonCardUp}" id="identityUp">
                        <input type="hidden" name="legalPersonCardDown" value="${office.legalPersonCardDown}"  id="identityDown">
                        <input type="hidden" name="ticketOfficeLicense" value="${office.ticketOfficeLicense}" id="license">

                        <div class="form-group">
                            <label>售票点名称</label>
                            <input type="text" name="officeName" value="${office.officeName}" class="form-control">
                        </div>
                        <div class="form-group">
                            <label>售票点地址</label>
                            <input type="text" name="officeAddress" value="${office.officeAddress}" class="form-control">
                        </div>
                        <div class="form-group">
                            <label>法人名称</label>
                            <input type="text" name="legalPersonName" value="${office.legalPersonName}"class="form-control">
                        </div>

                        <div class="form-group">
                            <label>法人电话</label>
                            <input type="text" name="legalPersonMobile" value="${office.legalPersonMobile}" class="form-control">
                        </div>
                            ...
                            <div class="raw-md-6">
                                ...
                                <div class="col-md-6 ">
                                    <div id ="identify-up" class="col-md-4" style="height: 250px;width: 375px;border-style: dashed;border-width: 1px">
                                        <img src="http://p7hdkn0j6.bkt.clouddn.com/${office.legalPersonCardUp}-pre" alt="">
                                    </div>
                                </div>

                                <div class="col-md-6 ">
                                    <div id ="identify-down" class="col-md-4" style="height: 250px;width: 375px;border-style: dashed;border-width: 1px">
                                        <img src="http://p7hdkn0j6.bkt.clouddn.com/${office.legalPersonCardDown}-pre" alt="">
                        ...
                        <div class="container">
                            ...
                            <div class="col-md-4" id="license-border"style="height: 250px;width: 375px;border-style: dashed;border-width: 1px">
                                <img src="http://p7hdkn0j6.bkt.clouddn.com/${office.ticketOfficeLicense}-pre" alt="">
